    ...
    return (
        <div className={styles["accordion"]}>
            <AccordionItem title="What is the easiest way to get started with Deriv API?">
                <p>
                    View our <Link href="/docs">code samples</Link>. You can use these code snippets in your app to open
                    a connection to our WebSocket API service. Explore our
            ...
            <AccordionItem title="How do I build my own front-end app?">
                ...
                <ol>
                    ...
                    <li>
                        Publish your fork using the <Link href="https://pages.github.com/">GitHub Pages</Link> facility.
                    </li>
                    <li>
            ...
            <AccordionItem title="How else can I earn?">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <Link href="/docs/app-registration">register</Link> your app. This is a percentage of contract
                        payouts, and it’s added to all contract prices in your app. At every month-end, the aggregate
                        markup is paid to you. Sign up as our affiliate and contact your Affiliate Manager to learn
                        more.
                    </li>
                </ol>
            </AccordionItem>
            <AccordionItem title="What does it mean if a schema property has the ‘sensitive’ attribute?">
                This means we will treat the value of this property as confidential, and will never return it in any API
                response. It is used for passwords and tokens.
            </AccordionItem>
            <AccordionItem title="What is copy trading?">
                <p>
                    Copy trading allows a client (the Copier) to automatically copy the trades of another client (the
                    Trader).
                </p>
                <p>
                ...
                <p>
                    Enabling ‘allow_copiers’ will also make the copytrading statistics call available. The statistics
                    call provides the information about an account. This is so that potential copiers have an idea about
