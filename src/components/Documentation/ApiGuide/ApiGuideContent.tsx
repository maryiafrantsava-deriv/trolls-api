    ...
    <>
        ...
        <div className={common["text-block"]}>
            ...
            <ol>
                ...
                <p>Send clients to:</p>
                <CopyText oauth="https://oauth.binary.com/oauth2/authorize?app_id=[..insert app_id..]" />
                <p>
                ...
                <CopyText oauth="https://oauth.binary.com/oauth2/authorize?app_id=[..insert app_id..]&l=ZH_CN" />
        ...
        <CallOptions category={0}/>
        <CallOptions category={1}/>
        <CallOptions category={2}/>
        <div className={common["text-block"]}>
