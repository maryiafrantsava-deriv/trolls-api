const playground_requests = [
    ...
    },
    {
        ...
        body: {
            ...
            leverage: 100,
            mainPassword: process.env.NEXT_PUBLIC_NEW_PASSWORD,
    ...
    },
    {
        ...
        body: {
            ...
            login: "MTR1000",
            new_password: process.env.NEXT_PUBLIC_NEW_PASSWORD,
            old_password: process.env.NEXT_PUBLIC_MT5_PASSWORD_CHANGE_OLD_PASSWORD,
            password_type: process.env.NEXT_PUBLIC_PASSWORD_TYPE,
        },
    },
    {
        ...
        body: {
            ...
            login: "MTR1000",
            password: process.env.NEXT_PUBLIC_MT5_PASSWORD_CHECK_PASSWORD,
            password_type: process.env.NEXT_PUBLIC_PASSWORD_TYPE,
        },
    },
    {
    ...
    },
    {
        ...
        body: {
            ...
            type: "trading",
            client_password: process.env.NEXT_PUBLIC_NEW_PASSWORD,
            residence: "id",
    ...
    },
    {
        ...
        body: {
            ...
            account_id: "MTR1000",
            new_password: process.env.NEXT_PUBLIC_TRADING_PLATFORM_PASSWORD_RESET_NEW_PASSWORD,
            platform: "mt5",
